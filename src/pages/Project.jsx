...
const Project = () => {
  ...
  return (
    <section className="relative mt-20 w-[95vw] h-fit lg:h-heightHome mx-auto border-2 border-neutral-content rounded-3xl shadow-md p-4 text-center bg-gradient-to-b from-base-200 via-info to-base-200 overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center lg:justify-between gap-8">
        <div className="w-full lg:w-1/2 mb-4 flex flex-col justify-start items-center">
          <img src={project.heroImage} alt={`${project.title} hero`} className="p-4 rounded-lg shadow-lg bg-base-200 bg-opacity-35 max-w-full w-full h-auto" />
        </div>
        <div className="w-full lg:w-1/2 flex flex-col justify-start items-around p-4 rounded-lg shadow-lg bg-base-200 bg-opacity-35">
          <div>
            <div>
            ...
            <ul className="min-w-full p-4 rounded-lg shadow-lg bg-base-200 bg-opacity-35 border-2 border-opacity-25 border-neutral-content">
              ...
              {project.keypoints.map((point, index) => (
                <li className='list-disc list-inside lg:text-left lg:ml-8'
                  key={index}>
                  {point}
                </li>
              ))}
