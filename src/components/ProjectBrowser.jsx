            ...
            <section key={index}>
              ...
              <div className="mb-2">
                <a href={project.gitURL} className="flex justify-center items-center">
                  ...
                  <svg className="fill-neutral-content" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <div className="collapse-content">
                  <ul>
                    {project.stack.map((icon, iconIndex) => (
                      <li key={iconIndex} className="inline-flex">
                        {icon}
                      </li>
                    ))}
                  </ul>
              ...
              <button className='btn btn-primary mt-4' onClick={() => handleMoreDetailsClick(project.localURL)}>
                more details &#8702;
              </button>
            </section>
          ))}
