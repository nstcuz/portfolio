...
const ProjectBrowser = () => {
  ...
  const handleMoreDetailsClick = (projectTitle) => {
            ...
            <section key={index}>
              ...
              <div className="mb-2">
                <a href={project.gitURL} className="flex justify-center items-center">
                  <p className='mr-2'>see the process at</p>
              ...
              <div className="mb-4">
                <img src={project.heroImage} alt={project.title + ' hero image'} className="w-full max-w-[420px] h-auto mx-auto object-cover" />
              </div>
              <div className='min-h-[300px] flex flex-col justify-around items-center'>
                <div className='accordian-container'>
                  <div className="collapse collapse-arrow bg-base-100 rounded-md">
                    <input type="radio" name="my-accordion-2" defaultChecked />
                    <h3 className="collapse-title font-medium">description</h3>
                  ...
                  <div className="collapse collapse-arrow bg-base-100 rounded-md">
                    ...
                    <h3 className="collapse-title font-medium">stack</h3>
                    <div className="collapse-content">
                      <ul className="flex justify-center items-center space-x-4">
                        {project.stack.map((tech, index) => (
                          <li key={index}>
                            <StackIcon name={tech} className="size-10" />
                          </li>
                        ))}
                      </ul>
                    </div>
