    ...
    <section className='hero mt-16 mb-8 w-[95vw] min-h-[500px] mx-auto shadow-md border-2 border-neutral-content rounded-3xl bg-gradient-to-b from-base-200 via-neutral to-base-200' id='contact'>
      <div className="hero-content text-center">
        <div className="max-w-md">
          ...
          <div className='lg:flex lg:justify-between lg:items-end lg:space-x-8'>
            <div>
              ...
              <a href="mailto:nst@niccousins.com">
                <svg className='mx-auto size-10 fill-neutral-content inline-block'
                      data-name="1-Email" 
            ...
            <div>
              <p className="py-6 my-4 lg:w-[260px] text-center">if you would like to see my code:</p>
              <a className='lg:' href="https://github.com/nstcuz">
