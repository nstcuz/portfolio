...
const DarkModeSwitch = () => {
  // init dark mode if not in local storage
  ...
  return (
    <div onClick={toggleDarkMode} className="cursor-pointer mr-6">
      {darkMode ? (
        <svg className="swap-off fill-warning size-6 sm:size-7 md:size-8" 
        ...
        <svg className="swap-off fill-current size-6 sm:size-7 md:size-8" 
             xmlns="http://www.w3.org/2000/svg" 
             viewBox="0 0 24 24">
